...
-   Example for a header that allows you to control whether teams \(meaning groups\) should keep their role assignments in SAP Analytics Cloud upon update: `ips.http.header.x-ignore-roles-if-missing`
