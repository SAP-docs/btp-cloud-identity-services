...
-   You have created a technical user with administrator permissions that will be used to call the UPS v4 API for creating or updating user account information. For more information, see [User Provisioning Service v4 API](https://developer.concur.com/api-reference/user-provisioning/v4.user-provisioning.html).
