...
-   When the value is set to `3`, the SCIM v4 API is used. It supports reading and provisioning of users and groups.
...
7.  Configure the transformations.
    ...
    **Default read and write transformation when using User v1 API \(connector version 1\):**
    ...
    **Default read and write transformation when using Identity v4 API \(connector version 2\):**
    ...
    **Default read and write transformation when using SCIM v4 API \(connector version 3\):**
    ...
    >       },
    >       {
    >         "sourcePath": "$.phoneNumbers[?((@.type != 'mobile') && (@.type != 'work') && (@.type empty false))]",
    >         "preserveArrayWithSingleElement": true,
    >         "optional": true,
    >         "targetPath": "$.phoneNumbers"
    >       },
    ...
    >       },
    >       {
    >         "sourcePath": "$['urn:ietf:params:scim:schemas:extension:sap:2.0:User']['phoneNumbers']",
    >         "optional": true,
    >         "preserveArrayWithSingleElement": true,
    >         "targetPath": "$['urn:ietf:params:scim:schemas:extension:sap:2.0:User']['phoneNumbers']"
    >       },
    >       {
    >         "targetPath": "$['urn:ietf:params:scim:schemas:extension:sap:2.0:User']['phoneNumbers'][*]['primary']",
    >         "type": "remove"
    >       },
    >       {
    >         "targetPath": "$['urn:ietf:params:scim:schemas:extension:sap:2.0:User']['phoneNumbers'][*]['type']",
    >         "type": "remove"
    >       },
    >       {
    >         "sourcePath": "$['urn:ietf:params:scim:schemas:extension:sap:2.0:User']['userUuid']",
