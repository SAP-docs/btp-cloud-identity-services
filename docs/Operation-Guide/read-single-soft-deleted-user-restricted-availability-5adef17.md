<!-- loio5adef17e830d4c8e87ebe212dc98cfb5 -->

# Read Single Soft-Deleted User \(Restricted Availability\)

Read the soft-deleted \(blocked\) but not permanently deleted user.



<a name="loio5adef17e830d4c8e87ebe212dc98cfb5__section_lyw_cqf_n2c"/>
...
The SCIM ID number of the deleted user that we want to read.
...
The response returns the blocked user whose SCIM ID is stated in the request.
