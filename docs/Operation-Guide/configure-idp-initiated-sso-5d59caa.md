...
> 
> <a name="idp_initiated_overview__table_cdx_mc2_ht"/>URL Parameters for IdP-Initiated SSO
> 
> 
> <table>
> <tr>
...
-   You have specified the default assertion consumer service \(ACS\) endpoint in the configuration of a trusted service provider \(SP\) in the administration console for Identity Authentication. For more information, see [Configure Trust](configure-trust-f96e4c5.md).
