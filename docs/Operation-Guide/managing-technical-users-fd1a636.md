<!-- loiofd1a6362963a4fb6a627a0afb31ed99e -->

# Managing Technical Users

As a user with assigned special policy authorizations, you can manage the technical users in the administration console for SAP Cloud Identity Services.
...
-   You are assigned with the respective technical user authorizations. For more information, see [Configure Technical User Authorizations](configure-technical-user-authorizations-885320d.md).



## Context

Technical users in SAP Cloud Identity Services are non-human identities that enable automated system-to-system communication and integration. These users are created and managed in the administration console via the *Technical Users* tile that appears under *Users & Authorizations*.
