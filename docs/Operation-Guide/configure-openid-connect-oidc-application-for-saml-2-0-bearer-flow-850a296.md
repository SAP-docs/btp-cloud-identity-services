...
8.  **Optional:** \(If you have added signing certificates in *Tenant Settings* or an application certificate in *Applications*.\) Under *Identity Provider Certificates*, choose the certificate to be used when a request to the application is signed.
