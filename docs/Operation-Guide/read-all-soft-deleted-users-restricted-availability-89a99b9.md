<!-- loio89a99b977ef7481e9256c0ae0de1ea59 -->

# Read All Soft-Deleted Users \(Restricted Availability\)

Get a list of all soft-deleted \(blocked\) but not deleted users in the tenant of SAP Cloud Identity Services.



<a name="loio89a99b977ef7481e9256c0ae0de1ea59__section_lyw_cqf_n2c"/>

## Prerequisites

-   You are a tenant administrator of SAP Cloud Identity Services with a *Manage Blocked Users* role. For more information, see [Edit Administrator Authorizations \(Restricted Availability\)](edit-administrator-authorizations-restricted-availability-297b3b2.md).
...
**URI:**<code>https://&lt;Cloud Identity Services domain&gt;/scim/Users?blocked=true</code>
...
GET
https://my-tenant.ondemand.com/scim/Users?blocked=true
```
...
The response returns a list with all users that are sofy-deleted \(blocked\) but not deleted in the tenant of Cloud Identity Services.
