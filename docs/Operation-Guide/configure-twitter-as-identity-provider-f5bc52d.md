...
6.  Save your configuration.
    ...
    If the operation is successful, you will receive the following message: ***Twitter authentication configured***. The slider next to the social provider is switched to *ON*.
