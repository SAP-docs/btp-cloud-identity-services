...
> ### Note:  
> This topic describes customer-managed configurations for the SAP Ariba Applications source system. For SAP-managed configurations, refer to the [SAP-Managed SAP Cloud Identity](sap-managed-sap-cloud-identity-6039a38.md) documentation.
