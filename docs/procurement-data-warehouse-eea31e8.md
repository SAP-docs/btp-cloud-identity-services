...
You can use Identity Provisioning to configure procurement data warehouse as a target system where you can provision users and groups. The target system consumes SCIM 2.0 API provided by SAP Analytics Cloud.
